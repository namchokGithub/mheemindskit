...
export function RandomStringPage() {
  ...
  const generate = () => {
    ...
    if (excludeAmbiguous) alphabet = alphabet.replace(/[O0Il1]/g, '')
    const total = Math.max(1, Math.min(200, Number(count) || 1))
